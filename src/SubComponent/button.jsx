...
const ButtonComponent = (props) => {
  ...
  return (
    <>
      {heroBtn ? (
        <button className="bg-colorFour px-12 py-4 text-2xl font-cinzel font-bold tracking-wide rounded-lg border-2 border-colorThree duration-200 hover:bg-colorOne hover:bg-opacity-70 hover:scale-105 hover:text-colorThree">
          Explore Surveys
        </button>
      ) : (
